//  Scroll decorator code from https://stanko.github.io/react-scroll-position-decorator/
import React, { Component } from 'react';

export defalut const withScroll = ComposedComponent => class ScrollDecorator extends Component {
  constructor() {
    super();
