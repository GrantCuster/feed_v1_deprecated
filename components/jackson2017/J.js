...
export const makeJ = (tick, l_width, l_height, center_x, center_y) => {
  const duration = 200;
  ...
  if (key0) {
    ...
    l.dx = l.cx = post_top.x;
    l.dy = l.cy = post_top.y;
    l.ax = l.bx = post_bot.x;
    l.ay = l.by = post_bot.y;
  } else if (key2) {
