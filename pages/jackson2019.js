...
class App extends Component {
  static async getInitialProps() {
    let first_choice = Math.floor(Math.random() * 4)
    return { first_choice: first_choice }
  }
  ...
  componentDidMount() {
    document.addEventListener('click', e => {
      ...
      this.setState(function(prevState, props) {
        ...
        let filtered = possible.filter(p => p !== prevState.choice)
        return { choice: filtered[Math.floor(Math.random() * filtered.length)] }
      })
    })
  }

  render() {
    let { first_choice } = this.props
    let { choice } = this.state

    let chosen = colors[choice === null ? first_choice : choice]

    return (
      <div>
        <Head>
          <title>Jackson 2019</title>
          <style
            dangerouslySetInnerHTML={{
              __html: `html { transition: all 0.5s linear; cursor: url(/static/images/jackson2019/wand.png), auto; }`,
            }}
          />

          <style
            dangerouslySetInnerHTML={{
              __html: `html { background: ${
                chosen[1]
              }; font-family: sans-serif; color: ${chosen[2]}; fill: ${
                chosen[2]
              }; }`,
            }}
          />
        ...
        <audio id="audio" autoPlay loop>
          <source src="/static/images/jackson2019/hp-short.mp3" />
        </audio>
        <svg
          style={{
            maxWidth: '90vw',
          ...
          viewBox="0 0 511.3 602.6"
        >
          <path
            d="M68.4,67.5l-8.2,3.2c-2.1,1.1-3,2.5-2.7,4.3c0.2,6.1,5.2,10.5,15,13.4l-0.7-70.9c-0.6-5.3-3.6-9.1-8.8-11.4h42.5
        ...
        c5.3-2.9,9.8-4.3,13.6-4.3C65.8,67.2,67.1,67.3,68.4,67.5z"
          />
          <path
            d="M178.6,57.7l-6.8-9.1c-2.4-3.2-3.6-6.6-3.6-10.2c0-1.4,0.4-2.5,1.1-3.4c1.5-2,8.9-6.9,22.3-14.8c5,3.6,10.3,7.6,15.9,12
        ...
        "
          />
          <path
            d="M229.7,94.7l11.4,5l-9.5-79.7h28.2v12.3l17.3-9.1L300.2,57l-5,51.3l-22.3,13.2l-13-18.2l0.2,41.8l-8.6-13.2l-0.9-1.8
        L249,159l-2.3,26.8L229.7,94.7z M277.9,101.5l-2.7-66.6l-15.4,7.3l0.2,57l11.1,8.2L277.9,101.5z"
          />
          <path
            d="M306.1,94.7l11.4,5l-9.5-79.7h28.2v12.3l17.3-9.1L376.5,57l-5,51.3l-22.3,13.2l-13-18.2l0.2,41.8l-8.6-13.2l-0.9-1.8
        l-1.6,28.9l-2.3,26.8L306.1,94.7z M354.2,101.5l-2.7-66.6l-15.4,7.3l0.2,57l11.1,8.2L354.2,101.5z"
          />
          <path
            d="M390,64.7h33.4c-4.2,0.9-6.4,2.9-6.6,5.9l2.7,15.9c1.2,7.1,2.5,10.8,3.9,10.9c0.9-0.1,6.8-11.7,17.7-34.6
        ...
        l11.4-19.9c1.1-2.7,1.6-5.5,1.6-8.4c0-7.2-4.4-22.5-13.2-45.8C394.7,67.5,392.7,66.1,390,64.7z"
          />
          <path
            d="M86.6,330.5l-5,42.3L57,385.9h-0.7l-55.7,0.9c8.3-2.6,12.5-7.1,12.5-13.6L12,259.8c-0.6-5.3-3.4-9.1-8.4-11.4l32.9-13.9
        ...
        l17.5-5l4.5-5.9l-2.5-49.8l-20.4-10.5L37.7,376.8z"
          />
          <path
            d="M101.3,356.8c1.7-10.8,2.5-24.2,2.5-40.2c0-12.1-0.5-25.5-1.6-40.2h20.4c0.6,11.5,0.7,25.2,0.2,41.1
        ...
        c-2.7,0-5.1-0.7-7-2C105.3,236.9,102.6,238.8,101.6,242.3z"
          />
          <path
            d="M132.5,281.2c7.7-5.3,16.5-11.9,26.4-19.8v20.4c7.9-6.8,13-10.2,15.4-10.2c0.8,0,1.3,0.2,1.6,0.7l10.7,18.6
        ...
        c-1.4,0-3.4,0-6.2,0c-2.8,0-4.9,0-6.2,0c3.9-1.7,6.3-3,7-4.1c0.6-0.6,0.9-2.1,0.9-4.5v-75.9L132.5,281.2z"
          />
          <path
            d="M229.7,266.8H217l-2,96.6c-0.3,0.6-0.5,1.2-0.5,1.8c0,2.7,3.6,7.2,10.9,13.4l-18.6-6.8c-7.3-2.7-11.1-6-11.6-9.8l1.1-96.1
        h-19.1c13-7.3,26-19.8,39.1-37.7l-0.5,28.9h11.8L229.7,266.8z"
          />
          <path
            d="M277.6,367.7c-0.8,0.3-5,1.4-12.7,3.4c10.5-8,15.9-16.9,16.4-26.6c0.6-0.9,1-10.5,1.1-28.9c0.1-17.9,0-32.3-0.5-43.4
        ...
        C293.9,358.8,285.8,364.4,277.6,367.7z"
          />
          <path
            d="M373.5,351.6l-24.1,1.1v-10l-17.2,9.1l-19-13.9l-4.5-68.8l27.7-15.7l13,18.2V225c0.6-3.3-0.9-7.4-4.5-12.3h26.4
        ...
        v-51.1l-11.3-14.1L331.4,272.3z"
          />
          <path
            d="M390.5,278.2l-6.8-9.1c-2.4-3.2-3.6-6.6-3.6-10.2c0-1.4,0.4-2.5,1.1-3.4c1.5-2,8.9-6.9,22.3-14.8c5,3.6,10.3,7.6,15.9,12
        c8,6.4,11.7,11.5,10.9,15.4l-0.9,51.8l8.4,0.5l-16.6,18.4c-3.9,2.7-6.6,4.1-8.3,4.1c-1.5,0-2.1-0.9-1.6-2.7v-8.2l-14.3,9.1
        ...
        L390.5,278.2z"
          />
          <path
            d="M440.2,283.2h33.4c-4.2,0.9-6.4,2.9-6.6,5.9l2.7,15.9c1.2,7.1,2.5,10.8,3.9,10.9c0.9-0.1,6.8-11.7,17.7-34.6
        c-0.2-1.7-0.5-2.6-1.1-2.9l-5.7-2.7l26.8,0.5c-7.6,14.1-17,31.3-28.4,51.7c-17.4,31.3-27.6,46.9-30.4,46.9c-0.2,0-0.3-0.1-0.5-0.2
        c-18.9-1.7-29.8-3-32.5-4.1c-6.8-0.9-14.8-4-24.1-9.3c-1.5-0.9-2.3-1.8-2.3-2.7c0-1.1,0.9-2.6,2.7-4.8c3.8-4.4,5.8-6.8,6.1-7.3
        c6.4-0.3,11.5-0.5,15.4-0.5c3.8,0,6.4,0.1,8,0.4c-0.1,1-0.7,1.7-1.6,2c-1.8,0.9-6.6,2.2-14.3,4l-4.1,5.2c5.3,2.7,18.9,4,40.9,3.8
        l11.4-19.9c1.1-2.7,1.6-5.5,1.6-8.4c0-7.2-4.4-22.5-13.2-45.8C444.9,286,442.9,284.6,440.2,283.2z"
          />
          <path
            d="M54.9,426.7c4.1,0.9,10.1,1.4,17.9,1.4c-1.4,0,3.1-0.1,13.4-0.2h5.5c1.2,0,2.5,0.1,3.9,0.2c-4.5,0.2-6.8,4.3-6.8,12.5v65.7
        ...
        C58.2,430.7,56.8,429,54.9,426.7z"
          />
          <path
            d="M115.7,496.4l-6.8-9.1c-2.4-3.2-3.6-6.6-3.6-10.2c0-1.4,0.4-2.5,1.1-3.4c1.5-2,8.9-6.9,22.3-14.8c5,3.6,10.3,7.7,15.9,12
        ...
        L115.7,496.4z"
          />
          <path
            d="M204,500.6c2.9-5,4.1-9.5,3.6-13.6c-2-2.6-6.6-7.2-13.9-13.9c-0.6,0-1.2,0.5-1.8,1.6l-3.2,25.9l2.3,45
        ...
        L204,500.6z"
          />
          <path
            d="M317.6,457.2c-1.1,0.5-2.4,1.2-4.1,2.3l-5.7,6.6l-24.8,27.5l20.2,58.2c1.8,5,5.5,8.9,11.1,11.6h-27.7c0-0.8,0.4-2,1.1-3.9
        ...
        c0-1.5-4-4.1-12-7.8c-1.1-0.1-2.3-0.6-3.6-1.4L317.6,457.2z"
          />
          <path
            d="M365.6,541.9c-1.2,0.9-6.1,4.6-14.5,11.1c-9.5,7.3-15.8,10.9-18.9,10.9c-0.5,0-0.8-0.1-0.9-0.5l-15.2-18.6
        ...
        l-1.4,0.2V541.9z"
          />
          <path
            d="M434,538.8c0.8,3.8-3.4,8-12.5,12.7c-7.6,3.9-13.8,6.2-18.6,6.8l-4.1-0.7c-15.3-11.8-23.4-19.4-24.3-22.7
        ...
        c1.1,3,3.1,5.2,6.1,6.6C407.5,549.4,410.6,547.2,412.2,544.2z"
          />
          <path
            d="M437.2,480.1c7.7-5.3,16.5-11.9,26.4-19.8v20.4c2.9-3.5,6.5-7.5,10.9-12c6.4-4.8,10.1-7.3,11.4-7.3c0.8,0,1.3,0.2,1.6,0.7
